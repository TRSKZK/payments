...
import { Button, NavbarItem, Popover, PopoverContent, PopoverTrigger, Skeleton, Spinner } from '@nextui-org/react'
...
function AuthenticatedUserHeader({ imageSrc, name, email }: {
